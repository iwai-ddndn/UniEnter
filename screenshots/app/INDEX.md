...
| チュートリアル 2/2 — Enter=改行設定のアプリを確認(LINE/Slackとも自動検出の例) | ![](04-tutorial-2-sendkey-light.png) | ![](04-tutorial-2-sendkey-dark.png) |
| 設定(既定状態) | ![](05-settings-light.png) | ![](05-settings-dark.png) |
| 設定(詳細オプション: アプリ側の送信キー を展開、LINE/Slackとも自動検出の例) | ![](06-settings-advanced-light.png) | ![](06-settings-advanced-dark.png) |
