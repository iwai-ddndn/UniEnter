...
const faqs = [
  ...
  {
    q: "インストール方法は?",
    a: "ダウンロードした UniEnter.pkg をダブルクリックし、インストーラに沿って進めてください(アプリケーションフォルダに入り、完了すると自動で起動します)。zip版は、お好みの場所に解凍して使えます。初回はmacOSに止められるので、上の「インストール手順」もあわせてご覧ください。",
  },
  {
    q: "容量やCPUはどのくらい使う?",
            ...
            <CardContent className="py-7">
              <ol className="space-y-5 text-sm">
                ...
                <li>
                  ...
                  <p className="mt-1 text-muted-foreground">
                    Touch IDまたはパスワードで認証すると、インストーラが始まります。インストールが完了すると UniEnter が自動で起動し、アクセシビリティ許可の案内が出ます。
                  </p>
                </li>
              </ol>
